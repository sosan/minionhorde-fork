# Spec: {{feature-slug}} — {{Functionality Name}} (Claude Adaptation — GENERATED from templates/context-files/SPEC.md)

> **GENERATED FILE — Source: `templates/context-files/SPEC.md` (OpenCode, 120L).**
> **Adapted for Claude:** Same structure, sections, and gates as OpenCode SPEC.md. Template variables identical. Tool mapping is docs-only (no tool diff). PRD ref uses `docs/PRD.md` (Claude: `templates/context-files/PRD-Claude.md` rendered). Test mapping section expanded to parity.
...
{{2-3 lines of context — what this functionality does and why it matters. Use domain terms from domain-modeling (if available).}}
