...
| Architect (`architect`) | Technical planning (tandem with PM; PM leads) | `docs/PLANNING.md`, `docs/FEATURE_PLAN.md`, `decision_*` entities | Never creates/modifies PRD.md; reads PRD.md and project_* entities; never over-engineers; does not orchestrate subagents; reports decisions to PM for validation |
